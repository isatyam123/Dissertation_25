function generate_pentadiagonal_dsm_convex_hull_order6()
    ...
    perms_list = generate_pentadiagonal_permutations(6);

    fprintf('\n=== Valid Pentadiagonal Permutation Matrices for Order 6 ===\n');
...
function perms_list = generate_pentadiagonal_permutations(n)
    ...
    for i = 1:size(P_all, 1)
        ...
        % Exclude matrices with 1s at (1,4), (1,5), (1,6), (2,5), (2,6), (3,6),
        % (4,1), (5,1), (5,2), (6,1), (6,2), (6,3)
        if is_valid && P(1,4) == 0 && P(1,5) == 0 && P(1,6) == 0 && ...
